...
INSERT INTO Reservations (UserId, ServiceId, ReservedDateTime, IsPromo, IsCanceled, IsServiceUnavailableMarker, ReportId, MarkId, AdditionalEquipment, Price, StartDateTime, EndDateTime) VALUES (5, 2, '2021-12-02 15:43:38.457', 0, 0, 0, null, null,'', 12.22, '2022-12-03 15:43:38.457', '2021-12-04 15:43:38.457')
INSERT INTO Reservations (UserId, ServiceId, ReservedDateTime, IsPromo, IsCanceled, IsServiceUnavailableMarker, ReportId, MarkId, AdditionalEquipment, Price, StartDateTime, EndDateTime) VALUES (6, 2, DATEADD(day, -3, GETDATE()), 0, 0, 0, null, null,'', 12.22, DATEADD(day, 8, GETDATE()), DATEADD(day, 12, GETDATE()))
