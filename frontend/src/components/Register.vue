<template>
    ...
    <div class="wrapper-input">     
        ...
        <input type="text" class="input-field input-username" placeholder="Username" v-model="username"
            :class="[ValidateUsername() == '' ? 'error-input' : '']">
        <input type="password" class="input-field input-password" placeholder="Password" v-model="password"
            :class="[ValidatePassword() == '' ? 'error-input' : '']">
        <div class="two-fields">
            <input type="text" placeholder="First name" class="small-input" v-model="firstname"
                :class="[firstname == '' ? 'error-input' : '']">
            <input type="text" placeholder="Last name" class="small-input" v-model="lastname"
                :class="[lastname == '' ? 'error-input' : '']">
        </div>
        <input type="text" class="input-field input-address" placeholder="Address" v-model="address"
            :class="[address == '' ? 'error-input' : '']">
        <div class="two-fields">
            <input type="text" placeholder="City" class="small-input" list="cities" v-model="city"
                :class="[ValidateCity() == '' ? 'error-input' : '']">
            <input type="text" placeholder="Phone number" class="small-input" v-model="phone"
        ...
        <textarea placeholder="Registration reason" v-show="usertype != 'regular-user'"></textarea>
    </div>
    ...
    <div class="card-footer">
        <span class="footer-text">
            ...
            Amazing!
            Sign in <a href="#" @click="changeMode()">here</a>
        </span>
    </div>
</template>
...
<script>
    export default {
        ...
        methods: {
            ...
            ValidateReason() {
                if (this.regreason == '' && this.usertype != 'regular-user')
                    return false;
                return true;
            }
        },
