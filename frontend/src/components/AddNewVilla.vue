    ...
    <div class="content-pane">
      ...
      <div class="input-wrapper">
        ...
        <input
          ...
          :class="[ValidatePercentage(capacity) ? '' : 'error-outline']"
        />
      </div>
      <div class="input-wrapper">
        ...
        <input
          ...
          :class="[ValidateNumber(numberOfRooms) ? '' : 'error-outline']"
        />
      </div>
      <div class="input-wrapper">
        ...
        <input
          ...
          :class="[ValidateNumber(numberOfBeds) ? '' : 'error-outline']"
        />
      </div>
    </div>
    <div class="content-pane">
      <div class="input-wrapper">
        ...
        <textarea
          ...
          :class="[ValidateString(promoDescription) ? '' : 'error-outline']"
        ></textarea>
      </div>
      <div class="input-wrapper">
...
export default {
  ...
  methods: {
    ...
    PullData() {
      ...
      let vue = this;
      fetch(
        "/api/VillaManagement/GetVillaInfo?villaId=" + this.$props.villaId,
        {
          method: "GET",
          redirect: "follow",
          headers: {
